...
class Recorder{
    ...
    public function __construct($appid="",$appkey=""){
        ...
        $this->inc = (object)array( "appid"         => $appid,
                                    "appkey"        => $appkey,
                                    "callback"      => "http://".$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].urlencode("?do=QQCallback"),
                                    "scope"         => "get_user_info",
                                    "errorReport"   => false );
...
class Oauth{
    ...
    function __construct($appid,$appkey){
        $this->recorder = new Recorder($appid,$appkey);
...
class QC extends Oauth{
     ...
     * @return Object QC
     */
    public function __construct($appid, $appkey, $access_token = "", $openid = ""){
